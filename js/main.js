    ...
    class Slideshow {
        ...
        init() {
			...
			this.DOM.menu = {
				...
				links: Array.from(this.DOM.el.querySelectorAll('.menu__item > .menu__item-link')),
				menuCtrls: {
			...
			this.DOM.links = {
				wrapper: this.DOM.el.querySelector('.menu'),
				items: Array.from(this.DOM.el.querySelectorAll('.menu__item > .menu__item-link'))
			};
			this.linksTotal = this.DOM.menu.links.length;
